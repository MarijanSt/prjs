...
public class ContainerEmptiedAtLocationEvent extends ContainerDomainEvent {

    private final ContainerTransitState transitState;
    private final ContainerContentState contentState;
    private final Location location;

    public ContainerEmptiedAtLocationEvent(LocalDateTime time, UUID containerId, ContainerTransitState transitState,
                                           Location location) {
        super(time, containerId, location);
        this.transitState = transitState;
        this.contentState = ContainerContentState.EMPTIED;
